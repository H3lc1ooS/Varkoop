<x-layouts.app title="Register">
    ...
    <main class="form-body flex flex-col items-center mt-20">
        ...
        <section class="flex justify-evenly w-full h-96 divide-x">
            ...
            <form method="POST" action="{{ route('register') }}"
                ...
                <input id="password" class="block mt-3 w-80 rounded-lg border-gray-300 bg-gray-100"
                    type="text"name="password" required autocomplete="new-password" placeholder="Senha">
                <x-input-error :messages="$errors->get('password')" class="mt-2" />

                <input id="password_confirmation" class="block mt-3 w-80 rounded-lg border-gray-300 bg-gray-100"
                    type="text" type="password" name="password_confirmation" required
                    autocomplete="new-password"placeholder="Confirmar Senha">
                <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />

                <section class="button flex justify-center mt-6">
                    <button type="submit" class="button text-white font-bold text-xl w-80">Entrar</button>
                </section>
            </form>

            <section class="login w-2/5 flex flex-col items-center justify-center">

                <a href="" class="flex justify-center items-center text-white font-bold facebook social rounded-3xl w-1/2">
                    <ion-icon name="logo-facebook" class="text-4xl"></ion-icon>
                    <p class="ml-2">Entrar com Facebook</p>
                </a>

                <a href="" class="flex justify-center items-center text-black font-bold social rounded-3xl w-1/2 border-solid border-black mt-4 bg-red-400">
                ...
                <p class="text-lg font-normal mt-5">Já tem uma conta? <a href="/login"
                        class="text-blue-600">Entrar</a></p>
            </section>
